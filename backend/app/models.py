...
class Car(Base):
    ...
    horse_power = Column(String(50), nullable=True)
    color_code = Column(String(50), nullable=True)
    assembly_plant = Column(String(100), nullable=True)
    mileage = Column(Integer, default=100000, nullable=True)
    custom_photo_url = Column(Text, nullable=True)
